...
type Tab = 'imagine' | 'crop' | 'resize' | 'filters';
...
const App: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<Tab>('imagine');
    ...
    return (
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center gap-6 animate-fade-in">
        <div className="relative w-full shadow-2xl rounded-xl overflow-hidden bg-black/20">
            ...
            {/* Sizer image prevents layout shift. It's invisible but occupies space. */}
            <img 
                src={currentImageUrl} 
                alt="" 
                aria-hidden="true"
            ...
            <div className="absolute inset-0 flex justify-center items-center">
                {activeTab === 'crop' ? (
                  <ReactCrop 
                    ...
                    aspect={aspect}
                    className="max-h-[60vh] flex justify-center items-center"
                  >
                    <img 
                      ref={imgRef}
        ...
        <div className="w-full">
            ...
            {activeTab === 'resize' && imgRef.current && (
              <ResizePanel 
            ...
            {activeTab === 'imagine' && <AdjustmentPanel onApplyAdjustment={handleApplyAdjustment} isLoading={isLoading} />}
